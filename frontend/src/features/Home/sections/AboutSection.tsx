...
const defaultAboutFeatures = [
  {
    ...
    description: "Hands-on labs, live sessions, and real-world projects designed to keep students engaged.",
  },
  {
    title: "Mentor support",
    description: "Personalized guidance from industry experts to help you build confidence and skills.",
  },
  {
    title: "Career ready",
    description: "Resume workshops, interview practice, and placement guidance for every learner.",
  },
];

export default function AboutSection() {
  return (
    <section id="about" className="bg-slate-950 py-28 text-white">
      <div className="mx-auto grid w-full max-w-[1440px] gap-12 px-6 sm:px-10 lg:grid-cols-[0.95fr_1.05fr] lg:px-12">
        <div className="space-y-6 lg:pr-10">
          ...
          <p className="max-w-xl text-lg leading-8 text-slate-300">
            TOTC brings together interactive lessons, live mentorship, and career services so learners can build practical skills and get hired.
          </p>
