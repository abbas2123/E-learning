...
router.get(
  "/courses/pending",
  adminController.getPendingCourses.bind(adminController),
);
router.post("/courses", adminController.createCourse.bind(adminController));
router.post(
  "/courses/:id/approve",
  adminController.approveCourse.bind(adminController),
);
router.post(
  "/courses/:id/reject",
  adminController.rejectCourse.bind(adminController),
);
router.delete(
  "/courses/:id",
...
router.get(
  "/enrollments",
  adminController.getEnrollments.bind(adminController),
);
...
router.patch(
  "/notifications/read",
  adminController.markNotificationsRead.bind(adminController),
);
